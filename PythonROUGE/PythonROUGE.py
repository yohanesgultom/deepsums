...
def PythonROUGE(guess_summ_list,ref_summ_list,ngram_order=1):
    """ Wrapper function to use ROUGE from Python easily. """
...
#        del temp
    ...
    ROUGE_path = '/home/yohanes/Workspace/deepsums/PythonROUGE/RELEASE-1.5.5/ROUGE-1.5.5.pl'
    data_path = '/home/yohanes/Workspace/deepsums/PythonROUGE/RELEASE-1.5.5/data'
...
if __name__ == '__main__':
    ...
    guess_summary_list = ['Example/Guess_Summ_1.txt']
